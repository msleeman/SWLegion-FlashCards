...
"Direct": "Issues an Order to a listed ally within range 2 during Issue Orders.",
...
"Fire_Control": "Allies within range 1 and LOS of this unit upgrade 2 attack dice against enemies.",
...
"Observe": "Place X observation tokens on an enemy unit to let friendly units reroll attack dice during attacks.",
...
"Self-Destruct": "At half wounds or more, for each unit within range 1 and in LOS, roll X black attack dice. That unit suffers 1 wound for each surge or crit, and 1 suppression for each hit.",
